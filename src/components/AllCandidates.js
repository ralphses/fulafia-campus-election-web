...
const sampleCandidates = [
  { id: 301, name: 'Candidate 1', party: 'Independent' },
  { id: 302, name: 'Candidate 2', party: 'Coding Party' },
  { id: 303, name: 'Candidate 3', party: 'Tech Alliance' },
];
        ...
        <table className="w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-indigo-600 text-white">
              ...
              <th className="py-2 px-4 font-bold">Party</th>
            </tr>
          </thead>
          <tbody>
